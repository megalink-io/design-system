...
import { Link } from 'components/basic/navigation';
import Checkbox from '.';

<Meta title="Components/basic/inputs/Checkbox" component={Checkbox} />
...
```tsx
import { Checkbox } from '@mds/components/basic/inputs';
```
